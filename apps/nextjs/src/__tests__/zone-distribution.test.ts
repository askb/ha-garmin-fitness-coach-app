...
describe("HR Zone Distribution", () => {
  ...
  it("zone percentages sum to approximately 100", () => {
    const zones: ZoneMinutes = { zone1: 30, zone2: 60, zone3: 20, zone4: 15, zone5: 5 };
  ...
  it("polarized training has >70% in zones 1-2", () => {
    const polarized: ZoneMinutes = { zone1: 100, zone2: 80, zone3: 10, zone4: 10, zone5: 5 };
  ...
  it("handles all-zero zones gracefully", () => {
    const empty: ZoneMinutes = { zone1: 0, zone2: 0, zone3: 0, zone4: 0, zone5: 0 };
  ...
  it("classifies training distribution type", () => {
    ...
    const polarized: ZoneMinutes = { zone1: 80, zone2: 20, zone3: 5, zone4: 10, zone5: 5 };
